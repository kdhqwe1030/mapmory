...
export default function Home() {
  ...
  const [selectedSavedPlaceId, setSelectedSavedPlaceId] = useState<number | null>(null);
  ...
  const handleSavedPlaceClick = useCallback((sp: typeof filteredPlaces[0]) => {
  ...
  const handleMapMarkerClick = useCallback((sp: typeof savedPlaces[0]) => {
    if (!sp.places.lat || !sp.places.lng) return
    const fakeSelectedPlace: SelectedPlace = {
      title: sp.places.name,
      address: sp.places.address ?? '',
